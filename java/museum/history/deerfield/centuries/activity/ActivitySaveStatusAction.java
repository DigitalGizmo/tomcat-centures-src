 ...
 */
public class ActivitySaveStatusAction extends DispatchAction {
  ...
  public ActionForward getForward( ActionMapping mapping, HttpServletRequest request, String statusLabel, boolean sendNotice ) throws Exception {
    ...
    activityService.saveActivityStatus( activityDTO, statusLabel, visitor );  
  ...
  /* ps = post save
  * don't cal getForward as that would remove the DTO
  */
  public ActionForward delete_check_ps( ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse resp )
    throws Exception {

    request.setAttribute( "status", "delete_check_ps" );
    return (mapping.findForward( "success" ));
  }
